    ...
    <>
      {loading ? (
        <div className="min-h-screen bg-gradient-to-br from-[#394f68] to-[#183b7e] flex items-center justify-center ">
          <h1 className="text-white text-5xl">Loading Your Weather Info...</h1>
        </div>
      ) : (
        <>
          {data && (
                ...
                <div className="p-5">
                  ...
                  <div className="grid grid-cols-1 xl:grid-cols-2 gap-5 m-2">
                    <StatCard
                      ...
                      metric={`${data.daily?.temperature_2m_max[0].toFixed(
                        1
                      )}°`}
                      color="yellow"
                    />
                    ...
                    <div className="flex space-x-3">
                      <StatCard
                        title="Wind Speed"
                        metric={`${data.current_weather?.windspeed.toFixed(
                          1
                        )}m/s`}
                        color="cyan"
                      />
